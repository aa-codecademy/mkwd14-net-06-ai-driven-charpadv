...
This homework focuses on LINQ and data querying, so AI can help you — but only if used correctly.

---

### 🧠 How to use AI effectively

- Use AI to understand LINQ concepts, not to write full queries  
- Ask what a query does, not just how to write it  
- Break complex queries into smaller steps  
- Use AI to debug and explain results  
- Always understand the result of your query  
...
2. Identify:
   - What data you need  
   - What condition you are applying  
   - What result you expect  
3. Start with simple LINQ (Where / Select)  
4. Gradually build more complex queries  
5. Test each step  
...
- Copy/pasting full LINQ queries  
- Writing one huge query without testing  
- Not understanding what the query returns  
- Ignoring edge cases (empty results, nulls)  
...
- Filtering → `Where`  
- Transforming → `Select`  
- Combining → chaining methods  
- Extracting → `First`, `Single`, etc.  
...
- You don’t understand what a LINQ method does  
- Your query returns wrong results  
- You don’t know how to combine multiple conditions  
...
```
Explain what this LINQ query does step by step.
```

```
What is the difference between Where and Select in this case?
```

```
How can I break this complex query into smaller parts?
```

```
Why is my LINQ query returning empty results?
```

```
Here is my query: [paste query]. What is wrong with it?
```
...
- Understand LINQ  
- Learn how to build queries step by step  
- Learn how to debug data queries  

AI should help you **understand your data and logic**, not replace your thinking.