...
//1
IEnumerable<string> task1 = people
    .Where(x => x.FirstName.StartsWith("R"))
    .OrderByDescending(x => x.Age)
    .Select(x => x.FirstName);

Console.WriteLine("====== TASK 1 ====");
foreach(string name in task1)
{
    Console.WriteLine(name);
}

//2
IEnumerable<Dog> task2 = people
    .SelectMany(x => x.Dogs)
    .Where(x => x.Color == "Brown" && x.Age > 3);


Console.WriteLine("====== TASK 2 ====");
foreach (Dog dog in task2)
{
    Console.WriteLine(dog.Name);
}

//3
IEnumerable<Person> task3 = people
    .Where(x => x.Dogs.Count > 2);

IEnumerable<string> task31 = people
    .Where(x => x.Dogs.Count > 2)
    .Select(x=>x.FirstName);
...
foreach (string person in task31)
{
...
//4
IEnumerable<Dog> task4 = people
    .FirstOrDefault(x => x.FirstName == "Freddy")
    .Dogs
    .Where(x => x.Age > 1);

Console.WriteLine("====== TASK 4 ====");
foreach (Dog dog in task4)
{
    Console.WriteLine(dog.Name);
}
...
//5
Dog task5 = people
    .FirstOrDefault(x => x.FirstName == "Nathen")
    .Dogs
    .FirstOrDefault();

Dog task51 = people
    .First(x => x.FirstName == "Nathen")
    .Dogs
    .First();
...
Console.WriteLine(task51.Name);


//6
IEnumerable<Dog> task6 = people
    .Where(x =>
