...
Use AI to help you THINK, not to generate full solutions.

### 🔹 Understanding the problem

```
Explain how to approach building a console application with multiple features step by step.
```
...
```
How should I structure a console application in C# with multiple responsibilities?
```

```
What classes would make sense for this type of application?
```

```
How do I separate logic (business logic vs UI) in a console app?
```
...
```
How can I validate user input in a console application?
```

```
What are common ways to store data in memory in C# (List, Dictionary, etc.)?
```

```
How do I repeat an action until the user enters valid input?
```
...
```
Give me 2 different approaches to solve this problem.
```

```
What are common edge cases I should consider?
```

```
What are common mistakes when building console applications like this?
```
...
```
Here is my code: [paste code] - Ask Copilot
What can be improved?
```

```
Why is my logic not working as expected?
```
...
- Do NOT ask for full solutions  
- Ask for explanations and guidance  
- Try to solve first, then ask AI  
- Always test and understand the code  
