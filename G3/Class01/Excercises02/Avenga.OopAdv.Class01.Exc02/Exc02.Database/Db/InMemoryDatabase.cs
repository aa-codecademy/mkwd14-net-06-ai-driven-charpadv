...
namespace Exc02.Database.Db
{
    public class InMemoryDatabase
    {
        ...
        public InMemoryDatabase()
        {
            Users = new List<User>
            {
                new User() { Username = "trajan", Password = "123", FullName = "Trajan Stevkovski", IsTeacher = true },
                new User() { Username = "tosho", Password = "123", FullName = "Tosho Todorovski", IsTeacher = true },
