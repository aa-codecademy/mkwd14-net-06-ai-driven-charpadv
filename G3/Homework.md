...
This is a larger application, so AI can help you — but only if used correctly.

---

### 🧠 How to use AI effectively

- Use AI to understand the problem, not to solve it for you  
- Break the problem into smaller parts and ask about each part  
- Ask for explanations, not full implementations  
- Use AI to validate your approach  
- Use AI to debug when something is not working  

---

### ⚙️ Recommended workflow

1. Read the whole task first  
2. Break it into smaller features (Login, Tracking, Statistics, etc.)  
3. Design your solution (classes, structure)  
4. Start implementing step by step  
5. If stuck → ask AI for hints  
6. Test and improve your solution  
...
- Asking AI to build the entire app  
...
- Write your whole homework  

---

### 🔍 When to ask AI

Good moments to ask AI:

- You don’t know how to start  
- You are stuck on a specific problem  
- Your code is not working  
- You want to improve your solution  

---

### 🎯 Goal

The goal is NOT to finish faster.  
The goal is to **learn how to build and think like a developer**.

AI is just a tool to help you get there.
